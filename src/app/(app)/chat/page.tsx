        ...
        <div className="flex flex-col md:flex-row h-full">
            ...
            <div className="flex-1 flex items-center justify-center p-6" style={{ background: "var(--bg)" }}>
                <div className="text-center max-w-xs">
                    ...
                    <h2 className="text-base font-semibold mb-1.5" style={{ color: "var(--text)" }}>No conversation selected</h2>
                    <p className="text-sm mb-6" style={{ color: "var(--text-3)" }}>Select a thread or start a new one.</p>
                    <button onClick={startNewThread} disabled={loading}
