            ...
            <div className="w-full max-w-sm">
                ...
                <div className="text-center mb-8">
                    <div className="flex items-center justify-center gap-2 mb-6">
                        <div className="w-8 h-8 rounded-xl flex items-center justify-center"
                            style={{ background: "linear-gradient(135deg, var(--accent), #f59e0b)", boxShadow: "0 4px 16px var(--accent-glow)" }}>
                            <AppIcon />
                        </div>
                        <span className="font-semibold text-base" style={{ color: "var(--text)" }}>SmartDesk</span>
                        <span className="text-[9px] font-mono font-bold px-1.5 py-0.5 rounded"
                            style={{ background: "var(--accent-2)", color: "var(--accent)", border: "1px solid rgba(217,119,6,0.22)" }}>AI</span>
                    </div>
                    <h1 className="text-2xl font-bold" style={{ color: "var(--text)" }}>Create your account</h1>
                    <p className="text-sm mt-1" style={{ color: "var(--text-3)" }}>Start managing smarter with SmartDesk</p>
                </div>
                ...
                <div className="rounded-2xl p-6 space-y-4" style={{ background: "var(--bg-1)", border: "1px solid var(--border)" }}>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        <Input id="name" type="text" label="Full name" placeholder="Anup Kumar"
                        ...
                        <Input id="password" type="password" label="Password" placeholder="At least 8 characters"
                            value={form.password} onChange={set("password")} required
                            hint="Minimum 8 characters" error={errors.general} />
