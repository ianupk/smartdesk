            ...
            >
                ...
                <section style={{ position: "relative", zIndex: 10, textAlign: "center", padding: "80px 24px 60px" }}>
                    ...
                    >
                        ...
                        <span style={{ fontSize: 12, fontWeight: 600, color: "#d97706", letterSpacing: "0.02em" }}>
                    ...
                    >
                        SmartDesk connects your Gmail, Calendar, Slack, GitHub, and more — then lets one AI assistant
                        handle them all.
                    </p>
                        ...
                        {(
                            [
                                ...
                                },
                                {
                                    ...
                                    logo: (
                                        <svg viewBox="0 0 24 24" width="18" height="18">
                                            ...
                                            <path d="M2 8h20v2H2z" fill="#1557b0" />
                                            <rect x="7" y="1" width="2.5" height="5" rx="1.25" fill="#4285F4" />
                                            <rect x="14.5" y="1" width="2.5" height="5" rx="1.25" fill="#4285F4" />
                                            <text
                                                x="12"
                                                y="19"
                                                textAnchor="middle"
                                ...
                                },
                                {
                                    name: "GitHub",
                                    logo: (
                                        <svg viewBox="0 0 24 24" width="18" height="18" fill="#e8e8f0">
                            ...
                            ] as { name: string; logo: React.ReactNode }[]
                        ).map(({ name, logo }) => (
                            <div
                                key={name}
                    ...
                    >
                        {[
                            ...
                            >
                                ...
                                <p style={{ fontSize: 14, lineHeight: 1.65, color: "var(--text-3)", margin: 0 }}>
                                    {desc}
                                </p>
                            </div>
                        ))}
