...
function SidebarIconBtn({
    ...
    return (
        <button
            ...
            title={title}
            className={cn(
                "w-9 h-9 rounded-lg flex items-center justify-center transition-all duration-150 text-[var(--text-3)] hover:text-[var(--text)] hover:bg-[var(--bg-3)]",
                className,
            )}
        >
            {children}
    ...
    return (
        <div className="flex-1 overflow-y-auto py-1">
            {loading ? (
                ...
                <>
                    <p
                        className="text-[0.6rem] font-semibold uppercase tracking-widest px-4 pb-1 pt-1"
                    ...
                    {threads.map((t) => {
                        ...
                        return (
                            <Link
                                ...
                                onMouseEnter={(e) => {
                                    if (!isActive) (e.currentTarget as HTMLElement).style.background = "var(--bg-2)";
                                }}
                                onMouseLeave={(e) => {
        ...
        <>
            ...
            >
                ...
                <div className="flex items-center gap-1">
                    <SidebarIconBtn
                        ...
                        title="New chat"
                        className={creating ? "opacity-50 pointer-events-none" : ""}
                    >
                        {creating ? <Spinner className="w-4 h-4" /> : <IconNewChat />}
                    </SidebarIconBtn>
                    <SidebarIconBtn onClick={() => setMobileOpen(true)} title="Menu">
                        <IconMenu />
                    </SidebarIconBtn>
                </div>
            </div>
            ...
            {mobileOpen && (
                <div className="md:hidden fixed inset-0 z-50 flex">
                    ...
                    />
                    <div
                        className="relative flex flex-col w-[280px] max-w-[85vw] h-full z-10"
                        style={{ background: "var(--bg-1)", borderRight: "1px solid var(--border)" }}
                    >
                        {/* Header row */}
                        <div className="flex items-center justify-between px-3 pt-3 pb-2 shrink-0">
                            <span className="text-sm font-semibold px-2" style={{ color: "var(--text)" }}>
                                Conversations
                            </span>
                            <SidebarIconBtn onClick={() => setMobileOpen(false)} title="Close">
                                <IconClose />
                            </SidebarIconBtn>
                        </div>
                ...
                {collapsed ? (
                    ...
                    <div className="flex flex-col items-center h-full py-3 gap-1">
                        ...
                        <Link href="/dashboard" title="Dashboard">
                            <SidebarIconBtn title="Dashboard">
                                <IconDashboard />
                            </SidebarIconBtn>
                        </Link>
