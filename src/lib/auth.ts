...
export const authOptions: NextAuthOptions = {
    ...
    callbacks: {
        ...
        // ─── session: ALWAYS reads all integration tokens fresh from DB ───────────
        // Never cached in JWT — so newly-connected integrations appear immediately.
