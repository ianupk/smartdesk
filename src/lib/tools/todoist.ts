...
export const listTasksTool = tool(
    ...
    },
    {
        ...
        description:
            "List Todoist tasks. Defaults to today + overdue. Use when user asks about their to-dos or what's due.",
        schema: z.object({
            filter: z
                .string()
                .optional()
...
export const createTaskTool = tool(
    async (
        ...
        try {
            ...
            const res = await tdFetch("/tasks", token, {
                method: "POST",
    ...
    },
    {
        ...
        description:
            "Create a new Todoist task. Supports natural language due dates like 'tomorrow', 'next Monday', 'every weekday'.",
        schema: z.object({
...
export const deleteTaskTool = tool(
    async (
        ...
        try {
            ...
            return todoistError("delete_task", err);
        }
    },
    {
...
export const moveTaskTool = tool(
    async (
        ...
        try {
            ...
            return todoistError("move_task", err);
        }
    },
    {
